...
from lib.utils.pearson import pearson, cov_pose as cov
...
class NetworkWrapper(nn.Module):
    ...
    def forward(self, batch):
        ...
        scalar_stats = {}
        loss = 0
        p_loss = cov(self.net.novel_pose_bw.bw_train, self.net.novel_pose_bw.bw_latent, self.net)
        loss += p_loss

        scalar_stats.update({'cov_loss': p_loss})
